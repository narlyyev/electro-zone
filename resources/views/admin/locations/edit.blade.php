            ...
            <div class="container-xl bg-white rounded my-3 p-3">
                ...
                <form action="{{ route('admin.locations.update', $location->id) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="mb-3">
                                <label for="name" class="form-label">Ady Tm</label>
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                <label for="name_ru">Ady Ru</label>
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                <label for="delivery_fee">Eltip bermegiň tölegi</label>
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                <label for="sort_order">Tertibi</label>
